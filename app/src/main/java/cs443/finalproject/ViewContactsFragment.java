...
import cs443.finalproject.Util.ContactListAdapter;
import cs443.finalproject.Util.DatabaseHelper;

public class ViewContactsFragment extends Fragment {

    private static final String TAG = "ViewContactsFragment";
    private String testImageURL = "https://pokemonletsgo.pokemon.com/assets/img/common/char-pikachu.png";
    ...
    private void setupContactsList(){
        ...
        //contacts.add(new Contact("Pikachu","(617)-222--1234", "Mobile", "guy@guy.com", testImageURL));

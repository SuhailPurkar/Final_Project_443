...
import cs443.finalproject.Util.ContactPropertyListAdapter;
import cs443.finalproject.Util.DatabaseHelper;
...
public class ContactFragment extends Fragment {
    ...
    private String second_date_of_visit = "12/12/18: Bulbasaur has a cold";
    private String first_date_of_visit = "12/2/18: Bulbasaur has a hiccup";
    ...
    private void init(){
        ...
        properties.add(date + " " + mContact.getEmail());

        /*properties.add(first_date_of_visit);*/
        //properties.add(second_date_of_visit);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.menuitem_delete:
                ...
                cs443.finalproject.Util.DatabaseHelper databaseHelper = new cs443.finalproject.Util.DatabaseHelper(getActivity());
    ...
    public void onResume() {
        super.onResume();
        cs443.finalproject.Util.DatabaseHelper databaseHelper = new DatabaseHelper(getActivity());
        Cursor cursor  = databaseHelper.getContactID(mContact);
